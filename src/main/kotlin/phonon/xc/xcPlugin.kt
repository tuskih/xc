...
public class XCPlugin: JavaPlugin() {
    ...
    private lateinit var api: XCApi
    ...
    override fun onEnable() {
        ...
        pluginManager.registerEvents(InspectListener(xc),this)

        // register commands
        this.getCommand("xc")?.setExecutor(Command(xc))
        this.getCommand("inspect")?.setExecutor(InspectCommand(xc))
