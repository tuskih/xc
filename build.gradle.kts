...
dependencies {
    ...
    paperDevBundle("1.20-R0.1-SNAPSHOT") // contains 1.18.2 nms classes
    ...
    if ( project.hasProperty("1.16") == true ) {
        ...
        java.toolchain.languageVersion.set(JavaLanguageVersion.of(17)) // need java==17 for 1.18.2
        sourceSets["main"].java.srcDir("src/nms/v1_19_R3")
        // apply<PaperweightUser>() // applies the paper weight plugin for minecraft nms classes
        paperDevBundle("1.19.4-R0.1-SNAPSHOT") // contains 1.18.2 nms classes
...
tasks {
    named<ShadowJar>("shadowJar") {
        ...
        doFirst {
            val supportedMinecraftVersions = setOf("1.16.5", "1.18.2", "1.19.4", "1.20")
            if ( !supportedMinecraftVersions.contains(target) ) {
                throw Exception("Invalid Minecraft version! Supported versions are: 1.16, 1.18, 1.19, 1.20")
            }
        }
